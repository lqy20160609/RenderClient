...
public class LightFragment extends FatherFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        stringIntegerHashMap.put(RecyclerViewSpacesItemDecoration.TOP_DECORATION,30);
        stringIntegerHashMap.put(RecyclerViewSpacesItemDecoration.BOTTOM_DECORATION,30);
        stringIntegerHashMap.put(RecyclerViewSpacesItemDecoration.LEFT_DECORATION,30);
        recyclerView.addItemDecoration(new RecyclerViewSpacesItemDecoration(stringIntegerHashMap));

        HashMap<String, Integer> stringIntegerHashMap_rgb = new HashMap<>();
        stringIntegerHashMap_rgb.put(RecyclerViewSpacesItemDecoration.TOP_DECORATION,30);
        recyclerView_rgb.addItemDecoration(new RecyclerViewSpacesItemDecoration(stringIntegerHashMap_rgb));
    ...
    //按钮和rgb_edit数据初始化
    public void init() {
//        mData.add(new LightColorButtonItem(Color.parseColor("#FFFFFFFF"), false));
